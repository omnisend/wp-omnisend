const DiscountNotice = () =>
{
    return (
        <div class="omnisend-custom-notice omnisend-notice">
            ...
            <a href="https://app.omnisend.work/registrationv2?utm_source=wordpress_plugin&utm_medium=banner_discount" target="_blank" class="omnisend-notice omnisend-custom-notice-discount-button">Get Omnisend discount</a>
        </div>
    );
};
