...
class OrderRefunded {
	 ...
	 */
	private $total_refunded_tax_amount = null;

	/**
	 * @var mixed $total_refunded_amount
	 */
	private $total_refunded_amount = null;
	 ...
	 */
	private array $refunded_line_items = array();
	...
	/**
	 * Converts OrderRefunded to array.
	 *
	 * If OrderRefunded is valid it will be transformed to array that can be used with Event
	 *
	 * @return array
	 */
