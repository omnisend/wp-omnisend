...
class Options {
	...
	public static function set_oauth_client_redirect_uri( string $redirect_uri ): void {
	...
	public static function set_oauth_client( string $client_id, string $client_secret, string $redirect_uri ): void {
		...
		self::set_oauth_client_redirect_uri( $redirect_uri );
	}
	...
	public static function delete_all(): void {
		...
		delete_option( self::OPTION_OAUTH_CLIENT_REDIRECT_URI );
	}
}
